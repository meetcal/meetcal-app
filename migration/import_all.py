...
INGEST_ACTIONS = {
    ...
    "saved_sessions": "savedSessions:upsertFromIngestion",
    "user_saved_sessions": "savedSessions:upsertFromIngestion",
...
MUTATION_TABLES = {"saved_sessions", "user_saved_sessions"}

NO_SECRET_TABLES = set()
