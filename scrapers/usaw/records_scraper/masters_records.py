...
class USAMWMastersRecordsScraper:
        ...
        with pdfplumber.open(pdf_content) as pdf:
            for page_num, page in enumerate(pdf.pages, 1):
                ...
                if not page_age_group and page_age_categories:
                    ...
                    print(
                        f"    Using page-based age category: {page_age_group} {current_gender}"
                    )
                ...
                for line in lines:
                    ...
                    if "SNA" in lift_upper or "SNATCH" in lift_upper:
                        ...
                        "CNJ" in lift_upper
                        or "C&J" in lift_upper
                        or "CLEAN" in lift_upper
                    ):
    ...
    def export_to_csv(
        self, records: List[Dict[str, Any]], filename: str = "usamw_masters_records.csv"
    ):
    ...
    def send_slack_notification(
        ...
        # Build message
        title = (
            "🏋️ USAMW Masters Records Update (DRY RUN)"
            if is_dry_run
            else "🏋️ USAMW Masters Records Update"
        )
    ...
    def run(self, dry_run: bool = False):
        ...
        if dry_run:
            ...
            self.send_slack_notification(result["to_insert"], [], is_dry_run=True)
        else:
            print("\n" + "=" * 60)
...
def main():
    ...
    parser.add_argument(
        "--pdf-url",
        type=str,
        default="https://storage.googleapis.com/production-ipower-v1-0-4/354/1018354/vixoE8Rk/9eb6a252fc45445f880522f8297d068f?fileName=NM20260330-WOMEN.pdf",
